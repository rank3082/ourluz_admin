...
export const WeeklyBookedCalender=()=>{
    ...
    return <div>
        ...
        <div style={{display:"flex", gap:"10%",padding:10,justifyContent:"center",alignItems:"center",textAlign:"center"}}>
           <div style={{fontWeight:700,fontSize:28}}>{` ${moment(from).format("MM/DD")} - ${moment(to).format("MM/DD")} `}</div>
